...
%TODO! - tatsächliche featureliste
...
%TODO! - client/server - beachtung von design pattern - model/view/controller -
% interface-technologie für Kommunikationsmodule zu besserer Wartbarkeit -
% trennung von admin- und user-system-teile
...
auf das model-view-controller- und singelton-pattern.
...
Vorgehen hat sich sehr gut bewährt.
...
des Instituts für Softwaretechnologie.
...
alle Mitglieder der Projketmannschaft teilnahmen.

Aufgrund der für ein Studienprojekt untypisch großen Verfügbarkeit an studentischen
Arbeitskräften wurden die zu entwickelnde Software parallel von zwei neunköpfigen
...
%TODO: Wie ist es dann tatsächlich gelaufen? - Planung vollständig am Anfang
% durchgeführt - Details vor jeder Iteration festgelegt - Feature-Vorschläge
% des Teams vor jeder It


\section{Projektplan}

%TODO! - mgl. vorhergehender Abschnitt hier einfügen und entsp. anpassen
...
%TODO! cvs - tech - argouml - eclipse - email - handy
