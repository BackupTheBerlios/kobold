...
Fï¿½ÂÂ¼r die Erstellung der Spezifikation wurde zu Beginn der ersten Iteartion der mit Abstand
grÃ¶ï¿½ÂÂŸte Aufwand getrieben. Die im Vorfeld gesammelten Anforderungen wurden dabei so umfassend
wie mï¿½ÂÂ¶glich in die Spezifikation eingebunden, wobei der Kunde in Einzelfragen noch einige
Male konsultiert wurde. In den nachfolgenden Iterationen wurde die Spezfikation angepasst,
wenn dies notwendig wurde; die dadurch eingebrachten Ã„nderungen waren allerdings erwartungsgemÃ¤ï¿½ÂÂŸ 
von sehr geringem Umfang.\par
Entsprechend der herausragenden Bedeutung der ersten Spezifikation, wurde diese allen zur Verfï¿½ÂÂ¼gung
stehenden Qualitï¿½ÂÂ¤tssicherungsmaÃŸnahmen unterzogen, von regelmÃ¤ï¿½ÂÂŸigen schriftlichen Statements bereits
der Vorversion, ï¿½ÂÂ¼ber zwei formale Reviews, bis hin zu einem abschlieÃŸenden protokollierten Walkthrough.
Die Spezifikation wurde spï¿½ÂÂ¤ter die Grundlage der ersten Abschlusstests des Kobold Systems.\par
Fï¿½ÂÂ¼r den Architekturentwurf wurde ein ï¿½ÂÂ¤hnliches Vorgehen gewï¿½ÂÂ¤hlt, das heiÃŸt der Aufwand fï¿½ÂÂ¼r die Erstellung
des Entwurfs wï¿½ÂÂ¤hrend der ersten Iteration war deutlich grÃ¶ï¿½ÂÂŸer, als der Anpassungsaufwand in den spï¿½ÂÂ¤teren
Iterationen. Als Vorbereitung wurde unmittelbar vor Beginn der Entwurfsarbeiten eine eigens dafï¿½ÂÂ¼r anberaumte
Schulung zum Thema Entwurfstechniken und Design Patterns durchgefï¿½ÂÂ¼hrt und bei der Erstellung des Entwurfs
wurde groÃŸer Wert auf die Verwendung diverser Entwurfsmuster gelegt, um eine mï¿½ÂÂ¶glichst kopplungsfreie und
...
der oben angesprochenen Schuluung gehï¿½ÂÂ¶rten, erstellte zunï¿½ÂÂ¤chst einen Grobentwurf, der intensiv vom restlichen 
Team geprï¿½ÂÂ¼ft und nach anschlieÃŸender Ausreifung durch die sehr detaillierte Ausgestaltung der wichtigsten Module 
und aller Schnittstellen soweit verfeinert wurde, dass er wï¿½ÂÂ¤hrend der spï¿½ÂÂ¤ter folgenden Implementierungsarbeiten 
...
meisten Fehler wird Kobold am 26.11.2004 als endgï¿½ltig ausgeliefert.
