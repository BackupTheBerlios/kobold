...
den Kobold Clients über remote procedure calls angesprochen.
Anfragen werden an die dafür zuständigen Komponenten des Kobold
Servers delegiert.

\section{Komponente WorkflowEngine}

Diese Komponente erhält Daten über durchgeführte (VCM-)Actionen
sowie Workflowobjekte, die auf die vorhandenen Regelmengen
angewendet werden. Dafür können benötigte Daten von den
Komponenten Benutzerverwaltung und Produktlinienverwaltung
abgerufen werden. Als Konsequenz können Workflows oder EMails an
die MessageQueue-Komponente übergeben werden.
...
Die Benutzerverwaltung ist zuständig für die Authentifizierung der
Benutzer beim Login und verwaltet deren Rollendaten. Sämtliche
Benutzerdaten können von dieser Komponente abgefragt werden.

\section{Komponente Produktlinien-/Produktverwaltung}

Diese Komponente verwaltet sämtliche auf dem Server zu
