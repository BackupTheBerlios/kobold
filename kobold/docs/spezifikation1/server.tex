...
mit einem Benutzernamen und dem dazu passenden Passwort. Diese sind dadurch bei ihrer Arbeit nicht an einen
...
\section{Gespeicherte Daten auf dem Kobold Server}
...
Der Kobold Server bildet für jeden Kobold-Benutzer eine Nachrichten-Queue. Werden Nachrichten oder Workflow-Objekte an einen Benutzer geschickt, so werden dieser in der Nachrichten-Queue in Form einer Warteschlange 
...
\section{Regelbasierte Workflowerzeugung}
