...
logische Symbol in einem Kreis dargestellt wird.  Es gibt die Möglichkeit, 
...
sich grafisch sehr stark an die vom Paper \cite{paper} vorgeschlagene Ansicht lehnt. Er hat Schreibrechte auf allen Ebenen der
Produkthierarchie. 
\begin{figure}[h!]
