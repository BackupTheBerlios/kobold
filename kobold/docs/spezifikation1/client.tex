...
\subsection{Der Produkt(linien) Editor}
...
\begin{figure}[h!]
\includegraphics[width=12cm]{../angebot/praesentation/visual.png}
   \caption{Screenshot des Produktlinien Editors}
\end{figure}
...
\item Ändern von Eigenschaften der Architekturelementen oder Beziehungen
...
\subsubsection{Interaktion mit der Maus}

Sämtliche Interaktionen mit den Architekturelementen und ihren
Beziehungen sollen im Einklang zur Bedienung moderner
Benutzungsoberflächen stehen. Interaktionen werden durch sog. 'Actions'
realisiert, die als zentrale Schnittstelle für alle Aktionen aus
Mausklicks, Menüelementen, Kontextmenüelementen oder
Symbolleistenelementen bedient werden.\par
Die detaillierte Ausgestaltung von Menüs und Symbolleisten ist durch die
Eclipse-basierte Grundlage von \product beliebig für die
Benutzerbedürfnisse konfigurierbar. Wesentlich sind lediglich die
'Actions' zur Interaktion. Exemplarisch werden in der ersten Iteration
die grundlegenden 'Actions' zur Verwaltung von Architekturen
implementiert (vgl. Verwaltung von Architekturen).

\newpage
\subsection{Der Rollen View}
...
Der Produktlinieningenieur hat im Produktlinieneditor
...
Der Produktingenieur kann im Produktarchitektureditor
standardmäßig jeweils genau ein Produkt auf einmal einsehen. Er
kann in der Rollen View die verschiedenen ihm zugeordneten
...
\subsection{Der Worklflow/Task View}
...
sein.\par Der Workfloweditor wird in der Iteration I durch den
von Eclipse zur Verfügung gestellten XHTML-Rendering Editor
realisiert, der Workflows im XHTML-Format visualisiert. In einer
