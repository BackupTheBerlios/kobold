...
Die Skalierbarkeit hängt ausschliesslich vom Server ab, dessen Leistungsfähigkeit von der Hardware und
...
Für den Client gibt es keine besonderen Anforderungen bzgl. der Verfügbarkeit. Der Kobold-Serverdienst soll mit mind. 99\% hoch verfügbar sein. 
Die Server-Verfügbarkeit hängt trotzdem von der Konfiguration des Rechners, der den Serverdienst zur Verfügung stellt, ab.
...
Fehlermeldung mitgeteilt. Sie führen nicht zum Programmabsturz. Genaueres folgt in einer späteren Iteration.
