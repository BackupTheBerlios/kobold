...
Um die notwendigen Meta-Informationen der unten aufgeführten
...
vor der nach einer VCM-Aktion ausgeführt wird. Folgende Metainformationen
...
Nachrichtenzustellung zum Kobold Serverdienst zu ermöglichen, wird
...
ausführbaren Dateien. Skripte können in beliebiger Reihenfolge
ausgeführt werden und durch Benutzerinteraktion mit beliebigen
Argumenten versehen werden, die in einer späteren Spezifikation genau
spezifiziert werden.\par
