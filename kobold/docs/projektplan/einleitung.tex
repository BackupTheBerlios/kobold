...
%% Team Werkbold
%% Projektplan
%% $Id: einleitung.tex,v 1.7 2004/02/05 12:56:47 garbeam Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\chapter{Einleitung}

Dieses Dokument beschreibt den Prozess, die Zeitplanung, die Organisation
...
Prozessbeschreibung vor Beginn jeder Folge-Iteration verfeinert. Dies
...
detaillierte Arbeitsplanung für die jeweilige Folge-Iteration ist
...
Produkten verwendet wird, hat. Um eine Produktlinie
...
Entwicklung des Produktlinien Managment Systems \product vereinbart, dass den
beschriebenen Anforderungskontext umsetzen wird.\par
