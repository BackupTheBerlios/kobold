...
Client-zu-Client Kommunikation über eine Nachrichten-Queue.
...
Die Speicherung aller für das Berechtigungskonzept notwendigen Daten wird
...
gespeichert (standardmäßig alle 10 Minuten).\par
...
gespeichert und bei der nächsten Nachrichtenabfrage des Benutzers an ihn
weitergeleitet.\par Die vom Server angebotene Nachrichten-Queue
ist zustandsbehaftet, das heißt dass bei nicht physisch begründeten
Ausfällen die Nachrichten-Queue in der Regel ohne Datenverlust
