\section{Metadaten}
Kobold verwendet Metadaten um Informationen über erstellte
...
Arbeitsplätzen zu verwenden. Diese Dateien werden in einem Repository
...
Die Datei ``.productmetainfo'' enthält folgende Informationen über
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item{Filedeskriptor: Pfad, Version der Datei, Letzte
          Änderung an Datei, Letzter Bearbeiter}
    \end{itemize}
    \item{Repository-Pfad: Name}
  \end{itemize}
%--------------------------
  ...
  \begin{itemize}
	...
	\begin{itemize}
	  \item{Verweis auf die Version einer Variante der verwendeten Core-Asset Komponente}
	\end{itemize}
    \end{itemize}
  \end{itemize}
%--------------------------
...
Die Datei ``.coreassetmetainfo'' enthält folgende Informationen über
