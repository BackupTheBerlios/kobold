...
Koboldadministrator gibt einen gältigen Namen fär die neue
...
\end{itemize}
Alternative Abläufe: \\
Falls der eingegebene Produktlinien-Name ungältig ist (leere Eingabe,
...
\item Der Kobold Administrator gibt einen gältigen PLE-Namen an. 
...
Alternative Abläufe: \\
\begin{itemize}
\item Falls der eingegebene Benutzername ungältig ist (z.B. leere
...
werden soll. 
\item Der Kobold Administrator gibt einen gältigen Benutzernamen an. 
...
Alternative Abläufe: \\
\begin{itemize}
\item Falls der eingegebene Benutzer-Name ungältig ist (leere Eingabe,
