...
The Kobold Server Administartion Tool is delivered as an executable jar file that is
intended to be run inside a terminal. One argument must be passed which is needed 
to locate the{\it sat.properties} file and to suite your local requirements: \par

\begin{verbatim}
java -Dkobold.sat.configFile=/home/kobold.client.serveradmin/sat.properties -jar serveradmin.jar
\end{verbatim}
