...
\begin{enumerate}
    ...
    \item Es muss möglich sein, Skripte vor und nach jeder VCM Aktion
    auszuführen. Werden mehrere Skripte vor oder nach einer Aktion
    ausgeführt, so muß die Reihenfolge durch Kobold vorgegeben werden
    können. Skripte können an jede, Komponente, Variante, Produkt und
    Poduktlinie geknüpft werden.
