...
Visualisierungsschicht (siehe Kapitel 3) des Architektureditor bereitgestellt,
...
%   \caption{Screenshot des Architektureditors(Prototyp)}
%\end{figure} %4Stimmen gegen die Grafik
...
\includegraphics[width=7cm]{../angebot/praesentation/verwaltung}
   \caption{Prototypistische Darstellung der Rollen View}
\end{figure}
...
Workflow, öffnet sich die jeweilige Detailansicht. Es
können Detailansichten zu mehreren Workflows gleichzeitig geöffnet
sein.\par Die Detailansicht wird in der Iteration I durch den
von Eclipse zur Verfügung gestellten XHTML-Rendering Editor
realisiert, der Workflows im XHTML-Format. In einer
späteren Iteration wird auch die Erstellung von angepassten
Workflows (siehe Abschnitt zu Workflows) unterstützt.
