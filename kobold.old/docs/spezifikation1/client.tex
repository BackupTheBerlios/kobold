...
\begin{itemize}
	\item Der Produktlinienarchitektur Editor (View)
...
an den Client übergeben; der Client reagiert seinerseits mit dem Bereitstellen der relevanten Sichten für den Benutzer.

\section{Der Produktlinienarchitektur Editor}
In dieser Ansicht wird die je nach aktiver Rolle relevante Sicht auf die Architektur der Produktlinie
