...
%% Team Werkbold
%% Angebot
%% $Id: begriffslexikon.tex,v 1.9 2004/02/20 13:06:02 garbeam Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\begriff}[2]
...
\begriff{Auschecken}{VCM-Aktion zum Anfordern einer Arbeitskopie aus dem Repository}
...
\begriff{Einchecken}{VCM-Aktion zum Rückschreiben der Arbeitskopie-Änderungen
ins Repository}
...
\begriff{Update}{VCM-Aktion, die die Arbeitskopie mit dem Repository
synchronisiert}
...
\begriff{VCM-Aktion}{Version Control Management Aktion, z.B. Auschecken,
    Einchecken, Synchroniseren, Updaten}
