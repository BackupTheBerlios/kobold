...
%% Team Werkbold
%% Angebot
%% $Id: begriffslexikon.tex,v 1.2 2004/02/16 14:42:45 neco Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\begriff}[2]
...
\begriff{Einchecken}{CVS-Funktion zum Rückschreiben der Arbeitskopie-Änderungen
ins CVS-Repository}
...
\begriff{View}{Eine rollenabhängige Sicht}
