...
%% Team Werkbold
%% Angebot
%% $Id: begriffslexikon.tex,v 1.3 2004/02/17 12:55:53 neco Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\begriff}[2]
...
\begriff{Arbeitskopie}{Kopie, mit der gearbeitet wird und tatsächlich verändert wird}
...
\begriff{Auschecken}{VCM-Funktion zum Anfordern einer Arbeitskopie aus dem 
VCM-Repository}
...
\begriff{Update}{VCM-Funktion, die die Arbeitskopie mit dem VCM-Repository
synchronisiert}
