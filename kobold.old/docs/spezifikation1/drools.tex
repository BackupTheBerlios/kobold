...
verwendet.\par
Dafür wird eine Regelbasis in XML für Drools erzeugt. Diese besteht aus einer Menge aller Regelmengen und 
...
vermeiden. Wird ein Workflow entwickelt, so ruft jeder Kobold Client, der den Workflow anstoßen sollte,
beim nächsten Login dieses Objekt ab. Der Anwender wird darüber in der Workflow-View des Kobold Clients
informiert.\newline
\newline
