...
Wie eingangs erwähnt wird der Client als Feature-Set implementiert.
Dieses Feature-Set besteht aus den für das Tool nötigen Plug-Ins und
dem Product Branding. Die einzelnen Plugins werden in den folgenden
Abschnitten dargestellt.

\subsubsection{Kurzspezifikation}
Das Feature Set dient als ''Container'' für die 3 Kern-Plug-Ins des
Kobold Clients. Es stellt eine ''Kurzinformations''-Seite, die Lizenzvereinbarungen
sowie Copyright Informationen zur Verfügung. Weiterhin stattet es das Produkt
...
<feature
   ...
   <description>
      	Hier wird spaeter eine ausführliche Beschreibung des Features
		stehen
   </description>
   ...
   <license>
      	Hier werden mögliche Lizenzvereinbarungen stehen
   </license>
...
%Hääääää was soll denn der folgende Satz heissen?! hab keine Ahnung hört sich 
%aber eggelhaft an! ;) schneipk
In den Produktlinien-Architekturen werden zusätzlich Versionen angezeigt.
Durch Doppelklick auf die graue Versionengrafik wird ein neues Editorfenster
geöffnet, in dem alle Versionen zu einer Variante angezeigt werden. Durch erneutes
Doppelklicken auf eine einzelne Version, werden die dazugehörigen Dateien/Verzeichnisse 
...
erweitern. Ein Doppelklick auf einen Block öffnet einen Dialog in dem %häää was ist ein Block?
...
Objekt können immer gelöscht werden. Falls diese schon in das CVS übernommen wurden,
...
\subsubsection{Mögliche Wrapper-Aktionen}
...
\subsubsection{Einschränkungen bei der Implementierung}
\begin{itemize}
...
VCMWrapperProvider} für die Eclipse Team
...
<extension point="org.eclipse.team.core.repository">
  <repository class="kobold.client.controller.vcm.VCMWrapperProvider"
      id="kobold.client.controller.vcm.VCMWrapperProvider"/>
</extension>
\end{verbatim}
%------------------------------------------------------------
