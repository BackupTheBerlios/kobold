...
\end{verbatim}
und erzeugt einen Tree. Der Contentprovider für den Tree befindet sich
in \verb+kobold.client.controler.roletree.RoleTreeContentProvider+. Dieser
bezieht die Architekturdaten von der Kommunikationskomponente sowie
von dem ArchitekturModel. Zur Darstellung wird der
\verb+kobold.client.controler.roletree.RoleTreeLabelProvider+ verwendet.
