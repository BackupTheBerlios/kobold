...
%% Team Werkbold
%% Angebot
%% $Id: einleitung.tex,v 1.1 2004/01/29 11:12:03 garbeam Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\chapter{Einleitung}

Dieser Projektplan beschreibt den Prozess, die Organisation
...
Es wird dem Auftraggeber als Projektplan für das Hauptprojekt vorgelegt.
\par
Das wesentliche Einsatzziel des Produktlininen Management Systems \product
ist die werkzeugunterstützte Entwicklung und Pflege von
Softwareproduktlinien und die Etablierung eines rollenbasierten
Entwicklungsprozesses. Dieser soll eine effiziente
Produktlinienentwicklung ermöglichen und wird durch \product unterstützt.

\section{Gültigkeit}

Aufgrund des evolutionären Vorgehensmodells wird die iterative 
Prozessbeschreibung am Anfang jeder Folge-Iteration verfeinert. Dies
resultiert in einer iterativen Vervollständigung und Auslieferung
des Projektplans am Anfang aller Folge-Iterationen. D.h. eine
detaillierte Arbeitsplanung für die jeweilige Iteration ist jeweils aus
der verfeinerten Version dieses Projektplans ersichtlich, die zum
jeweiligen Folge-Iterationsbeginn dem Auftraggeber ausgeliefert wird.\par
Dieser Projektplan ist in der groben Iterationsplanung jedoch für das
gesamte Hauptprojekt gültig. Durch die verfeinerte Arbeitsplanung der
Iteration I ist dieser Projektplan für diese Iteration bindend.

\section{Entwicklungsphilosophie}

Die Entwicklungsphilosophie folgt dem evolutionären Vorgehensmodell,
das sich in mehrere Iterationen unterteilt. Jede Iteration folgt dem
Wasserfall-Vorgehensmodell.\par

\subsection{Iteration I}
Die erste Iteration, die in verfeinertem Maße Gegenstand der
Arbeitsplanung in diesem Projektplan ist, gewährleistet die Erstellung
eines soliden Rahmensystems und stellt die Basisfunktionalität gemäß
den vereinbarten Anforderungen zur Verfügung.\par

\subsection{Weitere Iterationen}
...
Entwicklung des Produktlinien Managment Systems \product vereinbart,
dessen prozesstechnische Realisierung Gegenstand dieses Angebotes ist.
